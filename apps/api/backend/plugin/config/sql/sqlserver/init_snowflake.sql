...
VALUES (2049629108253622283, N'参数配置', 'PluginConfig', '/plugins/config', 7, 'codicon:symbol-parameter', 1, NULL, 1, 1, '', NULL, 2049629108245233667, GETDATE(), NULL);

INSERT INTO sys_menu (id, title, name, path, sort, icon, type, perms, status, display, link, remark, parent_id, created_time, updated_time)
VALUES
(2049629108253622284, N'新增', 'AddConfig', NULL, 0, NULL, 2, 'sys:config:add', 1, 0, '', NULL, 2049629108253622283, GETDATE(), NULL),
(2049629108253622285, N'修改', 'EditConfig', NULL, 0, NULL, 2, 'sys:config:edit', 1, 0, '', NULL, 2049629108253622283, GETDATE(), NULL),
(2049629108253622286, N'删除', 'DeleteConfig', NULL, 0, NULL, 2, 'sys:config:del', 1, 0, '', NULL, 2049629108253622283, GETDATE(), NULL);
...
(2202113487143047168, N'开发配置总开关', 'DEV', 'DEV_CONFIG_STATUS', '1', 1, NULL, GETDATE(), NULL),
(2202113487403094016, N'组件沙箱', 'DEV', 'DEV_SANDBOX_ENABLED', 'true', 1, NULL, GETDATE(), NULL);
