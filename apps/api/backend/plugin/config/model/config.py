...
class Config(Base):
    ...
    name: Mapped[str] = mapped_column(UniversalStr(32), comment='名称')
    type: Mapped[str | None] = mapped_column(UniversalStr(32), server_default=None, comment='类型')
    key: Mapped[str] = mapped_column(UniversalStr(64), comment='键名')
