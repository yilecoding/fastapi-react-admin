...
VALUES (2049629108253622287, N'数据字典', 'PluginDict', '/plugins/dict', 8, 'fluent-mdl2:dictionary', 1, NULL, 1, 1, '', NULL, 2049629108245233667, GETDATE(), NULL);

INSERT INTO sys_menu (id, title, name, path, sort, icon, type, perms, status, display, link, remark, parent_id, created_time, updated_time)
VALUES
(2049629108253622288, N'新增类型', 'AddDictType', NULL, 0, NULL, 2, 'dict:type:add', 1, 0, '', NULL, 2049629108253622287, GETDATE(), NULL),
(2049629108253622289, N'修改类型', 'EditDictType', NULL, 0, NULL, 2, 'dict:type:edit', 1, 0, '', NULL, 2049629108253622287, GETDATE(), NULL),
