...
insert into sys_menu (id, title, name, path, sort, icon, type, perms, status, display, link, remark, parent_id, created_time, updated_time)
values
(2049629108253622288, '新增类型', 'AddDictType', null, 0, null, 2, 'dict:type:add', 1, 0, '', null, 2049629108253622287, now(), null),
(2049629108253622289, '修改类型', 'EditDictType', null, 0, null, 2, 'dict:type:edit', 1, 0, '', null, 2049629108253622287, now(), null),
