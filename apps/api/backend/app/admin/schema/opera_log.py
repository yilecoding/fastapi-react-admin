...
class OperaLogSchemaBase(SchemaBase):
    ...
    request_headers: dict[str, Any] | None = Field(None, description='请求头（已脱敏）')
    response_headers: dict[str, Any] | None = Field(None, description='响应头')
    response_body: str | None = Field(None, description='响应体（超限截断）')
