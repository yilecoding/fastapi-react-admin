...
class DataRule(Base):
    ...
    name: Mapped[str] = mapped_column(UniversalStr(512), comment='名称')
    model: Mapped[str] = mapped_column(UniversalStr(64), comment='模型名称')
    column: Mapped[str] = mapped_column(UniversalStr(32), comment='模型字段名')
    ...
    value: Mapped[str] = mapped_column(UniversalStr(256), comment='规则值')
