  ...
  return (
    ...
    >
      ...
      <View className="gap-3">
        <Button variant="outline" onPress={() => router.push('/edit-profile')} testID="profile-edit">
          <Text>编辑资料</Text>
        </Button>
        <Button variant="outline" onPress={() => router.push('/change-password')} testID="profile-password">
          <Text>修改密码</Text>
        </Button>
